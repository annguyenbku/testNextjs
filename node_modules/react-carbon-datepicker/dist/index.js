...
var inputRef = React__default.createRef();
var yearContainerRef = React__default.createRef();
var yearBodyRef = React__default.createRef();
            ...
            return React__default.createElement(
                ...
                React__default.createElement(
                    ...
                    React__default.createElement(
                        ...
                        React__default.createElement('input', { type: 'date',
...
var _initialiseProps = function _initialiseProps() {
    ...
    this.renderYearWidget = function () {
        return React__default.createElement(
            ...
            _this3.state.showYears ? React__default.createElement(
                'div',
                { className: styles.cdbcyyYears, style: _this3.getStyles('yearSelectorBackground') },
                React__default.createElement('div', { className: styles.cdbcyyyBackdrop, onClick: function onClick() {
                        return _this3.setYearsVisibility(false);
                    } }),
                React__default.createElement('div', { className: styles.cdbcyyyPointer, style: _this3.getStyles('pointerColor') }),
                React__default.createElement(
                    'div',
                    ...
                    React__default.createElement('span', { className: styles.cdbcyyybCheck })
                ),
                React__default.createElement(
                    'div',
                    ...
                    _this3.getAvailableYears().map(function (year, index) {
                        return React__default.createElement('div', { className: styles.cdbcyyycItem,
    ...
    this.renderMonthWidget = function () {
        return React__default.createElement(
            ...
            _this3.state.showMonth ? React__default.createElement(
                'div',
                { className: styles.cdbcmMonths, style: _this3.getStyles('monthSelector') },
                React__default.createElement(
                    'div',
                    { className: styles.cdbcmmContainer },
                    React__default.createElement('div', { className: styles.cdbcmmBackdrop, onClick: function onClick() {
        ...
        return _this3.state.monthDetails.map(function (day, index) {
            ...
            return React__default.createElement(
                ...
                { className: styles.cdbcdbcDay + ' ' + (!day.valid ? styles.cdbcdbcDayDisabled : ''),
                    key: index },
                day.reminder && day.valid ? React__default.createElement('div', { className: styles.cdbcdbcdReminder, style: { background: day.reminder.color } }) : '',
                React__default.createElement(
                    'span',
                    { onClick: function onClick() {
    ...
    this.renderCalendar = function () {
        return _this3.state.showCalendar || _this3.state.alwaysShow ? React__default.createElement(
            'div',
            ...
            React__default.createElement(
                ...
                React__default.createElement(
                    ...
                    React__default.createElement(
                        ...
                        React__default.createElement('span', { className: styles.cdbcybLeftArrow })
                    ),
                    React__default.createElement(
                        'div',
                    ...
                    React__default.createElement(
                        ...
                        React__default.createElement('span', { className: styles.cdbcybRightArrow })
                    )
                ),
                React__default.createElement(
                    'div',
                ...
                React__default.createElement(
                    ...
                    React__default.createElement(
                        ...
                        React__default.createElement('span', { className: styles.cdbcdbLeftArrow })
                    ),
                    React__default.createElement(
                        'div',
                    ...
                    React__default.createElement(
                        ...
                        React__default.createElement('span', { className: styles.cdbcdbRightArrow })
                    )
                )
            ),
            _this3.state.reminder ? React__default.createElement(
                'div',
                { className: styles.cdbReminder },
                React__default.createElement(
                    'div',
                    { className: styles.cdbrName, style: _this3.getStyles('reminderName') },
                    React__default.createElement('span', { className: styles.cdbrnTag, style: { background: _this3.state.reminder.reminder.color } }),
